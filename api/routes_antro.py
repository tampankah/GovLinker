...
# Inicjalizacja klienta Anthropic (Grok)
client = Anthropic(
    api_key=XAI_API_KEY,
...
def initialize_rag():
    ...
    # Usunięcie OpenAIEmbeddings i zastąpienie tego bezpośrednim tworzeniem FAISS
    # W tym przypadku zakładamy, że FAISS nie będzie wymagać embeddings
    rag_store = FAISS.from_documents(documents)
